 ...
 */
class Ves_ProductList_Block_Gridwidget extends Ves_ProductList_Block_List
{
    /**
    ...
    protected function _construct($attributes = array())
    {
        ...
        $this->addCacheTag(Ves_ProductList_Model_Rule::CACHE_WIDGET_NEW_TAG);
    }
