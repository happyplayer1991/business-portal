 ...
 */
class Ves_ProductList_Block_Adminhtml_Rule extends Mage_Adminhtml_Block_Widget_Grid_Container
{
    public function __construct() {
        $this->_controller = 'adminhtml_rule';
        $this->_blockGroup = 'productlist';
        $this->_headerText = Mage::helper('productlist')->__('Rules Manager');
        $this->_addButtonLabel = Mage::helper('productlist')->__('Add Rule');
        parent::__construct();
    }
