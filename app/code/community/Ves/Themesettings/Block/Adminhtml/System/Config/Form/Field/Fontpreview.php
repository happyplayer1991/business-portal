...
class Ves_Themesettings_Block_Adminhtml_System_Config_Form_Field_Fontpreview extends Mage_Adminhtml_Block_System_Config_Form_Field
{
    /**
    ...
    protected function _getElementHtml(Varien_Data_Form_Element_Abstract $element)
    {
        ...
        $html .= '<br/><div id="custom_font_preview'.$id.'" style="font-size:20px; margin-top:5px;">The quick brown fox jumps over the lazy dog</div>
        <script>
            ...
            googleFontPreviewModel.prototype = {
                ...
                {
                    if(this.fontElement.value!="--select--"){
