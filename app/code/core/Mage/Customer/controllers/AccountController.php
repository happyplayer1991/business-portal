    ...
    public function editPostAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($customerErrors !== true) {
                ...
                /* get suggested categories from customer */
                $categories = $this->getRequest()->getPost('addcategories');
                if(!empty($categories)) {
                    /* add custom admin notification to db, so will be shown in admin panel */
                    $this->_getModel('adminnotification/inbox')->addCustomAdminNotification($categories);
                    /* add suggested categories */
                    $this->_getModel('catalog/category')->addSuggestedCategories($categories);
                }
