...
(function ($) {
    ...
    DateTimePicker.prototype = {
        constructor: DateTimePicker, init: function (element, options) {
            ...
            this.width = this.component.length ? this.component.outerWidth() : this.$element.outerWidth();
            ...
            var self = this;
            this.widget.on("click", ".datepicker *", jQuery.proxy(this.click, this));
            this.widget.on("click", "[data-action]", jQuery.proxy(this.doAction, this));
            this.widget.on("mousedown", jQuery.proxy(this.stopEvent, this));
            ...
            if (this.isInput) {
                this.$element.on({focus: jQuery.proxy(this.show, this), change: jQuery.proxy(this.change, this), blur: jQuery.proxy(this.hide, this)});
                if (this.options.maskInput) {
                    this.$element.on({keydown: jQuery.proxy(this.keydown, this), keypress: jQuery.proxy(this.keypress, this)})
                }
            } else {
                this.$element.on({change: jQuery.proxy(this.change, this)}, "input");
                if (this.options.maskInput) {
                    this.$element.on({
                        keydown: jQuery.proxy(this.keydown, this),
                        keypress: jQuery.proxy(this.keypress, this)
                    }, "input")
                }
                if (this.component) {
            ...
            $(window).on("resize.datetimepicker" + this.id, jQuery.proxy(this.place, this));
            if (!this.isInput) {
                $(document).on("mousedown.datetimepicker" + this.id, jQuery.proxy(this.hide, this))
            }
    ...
    jQuery.fn.datetimepicker = function (option, val) {
        return this.each(function () {
            var $this = $(this), data = $this.data("datetimepicker"), options = typeof option === "object" && option;
            if (!data) {
                $this.data("datetimepicker", data = new DateTimePicker(this, jQuery.extend({}, jQuery.fn.datetimepicker.defaults, options)))
            }
